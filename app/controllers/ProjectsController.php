	...
	public function showDueDates()
	{
		if(Auth::id()){
			$projects = Project::where('user_id', '=', Auth::id())
				...
				{
					$query->orWhere('project_status', '=', 'Started')
	...
	public function showPayDates()
	{
		if(Auth::id()){
			$projects = Project::where('user_id', '=', Auth::id())
				->where(function($query)
				{
					$query->orWhere('project_status', '=', 'Invoice Submitted')
